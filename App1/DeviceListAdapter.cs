...
namespace LightSwitch
{
    class DeviceListAdapter
    {
        ...
        private IList<ExtendedBluetoothDevice> mListBondedValues = new JavaList<>();
        private IList<ExtendedBluetoothDevice> mListValues = new JavaList<>();
	...
	public DeviceListAdapter(Context context)
         ...
         */
        public void addBondedDevices( Set<BluetoothDevice> devices)
        {
            List< ExtendedBluetoothDevice > bondedDevices = mListBondedValues;
